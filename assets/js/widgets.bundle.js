      ...
      if (e) {
        var t = e.getAttribute("data-kt-chart-color"),
          ...
          i = new ApexCharts(e, {
            ...
            plotOptions: {
              bar: { horizontal: !1, columnWidth: ["5%"], borderRadius: 6 },
            },
            legend: { show: !1 },
      ...
      if (t) {
        var a = t.hasAttribute("data-kt-negative-color")
          ...
          i = {
            ...
            colors: [KTUtil.getCssVariableValue("--bs-black"), a],
            grid: {
              borderColor: o,
              strokeDashArray: 4,
              yaxis: { lines: { show: !0 } },
    ...
    t = function (e) {
      ...
      if (t) {
        var a = parseInt(KTUtil.css(t, "height")),
          ...
          o = {
            series: [
              { name: "Rental Income", data: [54, 42, 75, 110, 23, 87] },
            ],
            chart: {
              fontFamily: "inherit",
              type: "bar",
          ...
          if (e) {
            var t,
              a = function () {
                ...
                var lineSeries = a.series.push(
                  am5xy.LineSeries.new(t, {
                    data: [
                      { category: "", value: 75 },
                      { category: "", value: 75 },
                    ],
                    strokeWidth: 10, // Adjusted width for the line
                    tensionX: 0.8,
                    tensionY: 1,
                  })
                );
  
                // Add a LabelBullet to display "75%" in the middle
                var labelBullet = lineSeries.bullets.push(
                  am5.LabelBullet.new(t, {
                    locationX: 0.5,
                    locationY: 0.5,
                  })
                );
                labelBullet.text.setAll({
                  text: "{valueY}%",
                  fontWeight: "bold",
                  fill: am5.color(KTUtil.getCssVariableValue("--bs-dark")),
                  fontSize: 20,
                });
